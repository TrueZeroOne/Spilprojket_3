...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        private static void OnActionChange(object obj, InputActionChange change)
        {
            ...
            InputActionAsset actionAsset = actionMap?.asset ? actionMap.asset : obj as InputActionAsset;

            foreach (RebindActionUI component in s_RebindActionUIs)
            {
                ...
                if (referencedAction == action ||
                    referencedAction.actionMap == actionMap || referencedAction.actionMap?.asset == actionAsset)
        ...
        [Tooltip("Event that is triggered when the way the binding is display should be updated. This allows displaying bindings in custom ways, e.g. using images instead of text."),SerializeField]
        private UpdateBindingUIEvent m_UpdateBindingUIEvent;

        [Tooltip("Event that is triggered when an interactive rebind is being initiated. This can be used, for example, to implement custom UI behavior while a rebind is in progress. It can also be used to further customize the rebind."),SerializeField]
